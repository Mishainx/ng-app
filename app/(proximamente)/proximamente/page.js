...
export default function Proximamente() {
  return (
    <div className="h-screen bg-[#00091B] text-white flex items-center justify-center px-4">
      ...
      <div className="relative text-center max-w-3xl z-10 flex flex-col items-center justify-center space-y-10">
        ...
        <div className="flex flex-col lg:flex-row justify-center gap-20 items-center">
          {/* Sonic */}
          <div className="hidden lg:block w-1/6 drop-shadow-2xl">
            <Image
          ...
          {/* Logo centrado */}
          <div className="w-full sm:w-2/3 md:w-1/2 lg:w-2/3 mx-auto flex justify-center">
            <Image
        ...
        {/* Subtítulo */}
        <p className="text-base font-bold sm:text-lg md:text-xl mb-10">
